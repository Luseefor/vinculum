    ...
    <section className="rounded-[6px] border border-[var(--border-subtle)] bg-transparent">
      ...
      <div className="space-y-3 p-3 pt-3">
        ...
        <div className="rounded-[6px] border border-[var(--border-subtle)] bg-transparent p-2">
          <p className="mb-1 text-[10px] font-semibold uppercase tracking-[0.12em] text-[var(--text-tertiary)]">Selected object JSON</p>
...
function Diagnostic({ label, value, mono = false }: { label: string; value: string; mono?: boolean }) {
  return (
    <div className="rounded-[6px] border border-[var(--border-subtle)] bg-transparent px-2 py-1.5">
      <p className="text-[10px] font-semibold uppercase tracking-[0.1em] text-[var(--text-tertiary)]">{label}</p>
