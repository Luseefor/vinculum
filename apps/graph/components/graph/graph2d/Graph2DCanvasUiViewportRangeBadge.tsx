...
export function Graph2DCanvasUiViewportRangeBadge({ axisPair, viewportRange }: Graph2DCanvasUiViewportRangeBadgeProps) {
  return (
    <div
      data-testid="graph2d-viewport-range-badge"
      className="rounded border border-[var(--border-subtle)] bg-[var(--surface-overlay)] px-2 py-1 font-mono text-[10px] text-[var(--text-secondary)] shadow-lg"
    >
